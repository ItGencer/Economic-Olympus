...
const outerCells: InfoItem[] = [
  ...
  {
    title: 'Реклама',
    text: 'Платна можливість підняти імідж. Гравець обирає від +1 до +9 іміджу, кожен пункт коштує 1500 $.',
  },
  {
    title: 'Податкова',
    text: 'Відкриває картку зі штрафом: ПДФО 18%, військовий збір 5%, ЄСВ 22% від позитивного балансу, плюс 5% штрафу від кожного податку.',
  },
  {
          ...
          <div className="min-w-0">
            ...
            <Section id="rings" title="Два кола поля" eyebrow="Шлях розвитку">
              ...
              <p>
                ...
                немає боргу, баланс не нижче 0 $ та є 5 успішних ділових
                зустрічей поспіль після погашення боргу. Після п’ятої вдалої
                зустрічі гра запропонує вибір: перейти на зовнішнє коло або
                залишитись всередині. Якщо відмовитись, лічильник успішних
                зустрічей скидається до 0.
              </p>
            </Section>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                <article className="rounded-md border border-slate-200 bg-white p-4 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6">
                    ...
                    внутрішнього кола. Поки баланс нижче 0 $, лічильник
                    успішних ділових зустрічей завжди дорівнює 0. Борг понад
                    50 000 $ вмикає попередження.
