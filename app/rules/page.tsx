...
const casinoSteps = [
  ...
  'Якщо баланс позитивний, ставка може бути від 0 $ до поточного балансу.',
  'Якщо у гравця борг, казино все одно дозволяє зіграти в кредит: ставка може бути від 0 $ до 1000 $.',
            ...
            >
              <div className="space-y-8">
                ...
                <article>
                  ...
                  <p className="mt-3">
                    Казино можна прийняти навіть із боргом. Якщо баланс
                    позитивний, ставка обмежена поточним балансом. Якщо баланс
                    від’ємний, доступна ставка в кредит до 1000 $.
                  </p>
                  <div className="mt-4">
